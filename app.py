...
app.config['MAIL_USERNAME'] = 'yogeshrajgure.vraj@gmail.com'
app.config['MAIL_PASSWORD'] = 'password'
app.config['MAIL_USE_TLS'] = True
app.config['MAIL_USE_SSL'] = False
app.config['MAIL_DEFAULT_SENDER'] = ('FIGHT COVID', 'yogeshrajgure.vraj@gmail.com')
...
users = [['yogeshrajgure.vraj@gmail.com', 'Yogesh Rajgure']]
